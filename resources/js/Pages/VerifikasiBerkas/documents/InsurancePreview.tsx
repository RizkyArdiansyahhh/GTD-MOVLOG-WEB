    ...
    return (
        <div className="relative bg-white p-6 sm:p-7 rounded-lg border border-slate-200 shadow-sm text-slate-800 text-[11px] font-sans">
            ...
            <div className="mb-4 bg-[#06283A]/5 border border-[#06283A]/20 p-3 rounded text-[10px] grid grid-cols-1 md:grid-cols-3 gap-2">
                ...
                <div>
                    <span className="text-slate-500 block">1. Commercial Invoice Number:</span>
                    <strong className="font-mono text-slate-900">{relatedDocs.commercialInvoiceNumber || 'INV-2026-017'}</strong>
                </div>

                {/* 2. Bill of Lading Number */}
                <div>
                    <span className="text-slate-500 block">2. Bill of Lading Number:</span>
                    <strong className="font-mono text-slate-900">{relatedDocs.billOfLadingNumber || 'BOL-2026-017'}</strong>
                </div>

                {/* 3. Shipment Contract Number */}
                <div>
                    <span className="text-slate-500 block">3. Shipment Contract Number:</span>
                    <strong className="font-mono text-slate-900">{document.contractNumber || 'CTR-GTD-2026-015'}</strong>
                </div>
            </div>
            ...
            {/* 7. Amount Insured */}
            <div className="border-2 border-[#06283A] rounded-lg p-3 bg-gradient-to-r from-[#06283A]/5 to-[#F6C343]/10 mb-4 flex items-center justify-between">
                <div>
                    <span className="text-[10px] font-bold text-[#06283A] uppercase block">
                        7. Amount Insured (Total Policy Coverage)
                    </span>
                    <span className="text-[9px] text-slate-500">All-Risk Cargo Coverage under Maritime Protocol</span>
                </div>
                <div className="text-right">
