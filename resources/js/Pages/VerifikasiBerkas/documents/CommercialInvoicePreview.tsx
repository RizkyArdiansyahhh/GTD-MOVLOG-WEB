...
export default function CommercialInvoicePreview({ document }: CommercialInvoicePreviewProps) {
    ...
    return (
        <div className="relative bg-white p-6 sm:p-7 rounded-lg border border-slate-200 shadow-sm text-slate-800 text-[11px] font-sans">
            ...
            <div className="mb-4 bg-slate-50 p-2.5 rounded border border-slate-200 text-[10px]">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                    ...
                    <div>
                        ...
                        <strong className="font-mono text-slate-900">{document.contractNumber || 'CTR-GTD-2026-004'}</strong>
                    </div>
                    <div>
                        ...
                        <tbody className="divide-y divide-slate-200">
                            {cargoList.map((item, idx) => (
                                <tr key={idx} className="bg-white">
                                    ...
                                    <td className="py-1.5 px-2 text-right font-mono text-[9px] text-slate-600">
            ...
            {/* 6. Total Quantity */}
            <div className="border border-slate-200 rounded p-2.5 bg-slate-50 mb-4">
                <h4 className="font-bold text-[#06283A] uppercase tracking-wide border-b border-slate-200 pb-1 mb-2 text-[10px]">
                    6. Total Quantity & Grand Total
                </h4>
                <div className="grid grid-cols-3 gap-2 text-[10px] text-center">
                    <div className="bg-white p-1.5 rounded border border-slate-200">
                        <span className="text-slate-500 block text-[9px]">a. Total of Packages</span>
                        <strong className="text-slate-900 font-mono">{totals.totalPackages || '-'}</strong>
                    </div>
                    <div className="bg-white p-1.5 rounded border border-slate-200">
                        <span className="text-slate-500 block text-[9px]">b. Total of Goods</span>
                        <strong className="text-slate-900 font-mono">{totals.totalGoods || '-'}</strong>
                    </div>
                    <div className="bg-[#06283A] text-white p-1.5 rounded border border-[#06283A]">
                        ...
                        <strong className="text-[#F6C343] font-mono text-xs">{totals.totalPrice || '-'}</strong>
                    </div>
                </div>
            </div>
