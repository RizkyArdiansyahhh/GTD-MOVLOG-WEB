...
export default function DocumentList({
    ...
    if (documents.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center p-8 text-center bg-slate-50/50 rounded-xl border border-dashed border-slate-200 my-auto h-full min-h-[260px]">
                <div
